<template>
  <el-container>
    ...
    >
      <div
        class="option"
        style="margin-top: 30px; height: 80px; padding-left: 25px"
      >
        <img
          width="86%"
          src="https://mp-e0d15f0f-d6bf-4f95-b183-b82aede04535.cdn.bspapp.com/111/logo (3) - 副本.png"
          alt=""
        />
      </div>
